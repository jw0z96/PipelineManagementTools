...
class NameSpaceDialog(QDialog):
	def __init__(self, asset, parentWindow = None, *args, **kwargs):
		super(NameSpaceDialog, self).__init__(parentWindow, *args, **kwargs)
	...
	def initUI(self):
		...
		file = QFile(currentDir+"/nameSpaceDialog.ui")
		...
		self.ui.nameSpaceLabel.setText("Enter unique namespace for: " + self.selectedAsset)
